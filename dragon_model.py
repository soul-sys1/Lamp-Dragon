        ...
        try:
            ...
            if won:
                ...
                if game_type == "coffee_art":
                    ...
                    result["skill_changes"]["кофейное_мастерство"] = 5
                    result["skill_changes"]["артистизм"] = 3
                    result["message"] = "🎨 Прекрасный кофейный арт! Навыки улучшены!"
                elif game_type == "memory":
                    self.skills["интеллект"] = min(100, self.skills["интеллект"] + 4)
                    result["skill_changes"]["интеллект"] = 4
                    result["message"] = "🧠 Отличная память! Интеллект улучшен!"
