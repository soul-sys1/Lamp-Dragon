    ...
    "фэнтези": [
        {
            ...
            "комментарий_дракона": escape_markdown(
    ...
    "приключения": [
        {
            ...
            "комментарий_дракона": escape_markdown(
                "🗺️ *Карта сокровищ — это как игра в прятки, только с золотом!*\n\n"
        ...
        },
        {
            ...
            "комментарий_дракона": escape_markdown(
                "✈️ *Кругосветное путешествие — это же целая жизнь приключений!*\n\n"
    ...
    "детектив": [
        {
            ...
            "комментарий_дракона": escape_markdown(
                "🕵️ *Я бы хотел быть детективом, как Шерлок Холмс!*\n\n"
