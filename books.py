...
Версия БЕЗ HTML-разметки в описаниях
"""
import random
...
BOOKS_DATABASE = {
    ...
    "детектив": [
        {
            "название": "Приключения Шерлока Холмс",
            ...
            "описание": (
                ...
                "Вместе с доктором Ватсоном он расследует: исчезновение инженера с верхнего этажа, тайну пёстрой ленты, свистящей в ночи, загадку голубого карбункула в рождественском гусе, пропажу серебряного слитка и плана военного порта.\n\n"
    ...
    "поэзия": [
        ...
        },
        {
            ...
            "описание": (
                ...
                "Я никогда не ухожу в открытое море. Моё место — здесь, в гавани. Но я счастлив, потому что делаю важное дело: помогаю большим кораблям начинать и заканчивать их путешествия."
            ),
            "комментарий_дракона": (
